// --- EventRecorder portability shim for PY32 + armclang ---
// If CMSIS didn't define these, define them here so EventRecorder builds.
...
#ifndef __NO_INIT
// Put object in a no-init section so startup code doesn't zero it.
// If you don't have a .noinit section in your linker script, you can
// just drop this attribute and accept init/zeroing by redefining it empty.
